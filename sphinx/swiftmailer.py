...
class SwiftmailerStyle(Style):
    ...
    Keyword: "#FF8400", # class: 'k'
        Keyword.Constant: "#004461", # class: 'kc'
        Keyword.Declaration: "#004461", # class: 'kd'
        Keyword.Namespace: "#004461", # class: 'kn'
        Keyword.Pseudo: "#004461", # class: 'kp'
        Keyword.Reserved: "#004461", # class: 'kr'
        Keyword.Type: "#004461", # class: 'kt'
