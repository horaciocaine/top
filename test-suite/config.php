...
define('SWEETY_INCLUDE_PATH',
  SWEETY_HOME . '/../application/classes' . PATH_SEPARATOR .
  SWEETY_HOME . '/../application/controllers' .
...
define('SWEETY_TEST_PATH',
  ...
  PATH_SEPARATOR . SWEETY_HOME . '/../tests/system'
  );
...
define('SWEETY_SUITE_NAME', 'swiftmailer.org Test Suite');
...
require_once SWEETY_HOME . '/../application/testenvironment.php';
